...
class TrendsViewController: UIViewController {
    let trendsList: [String] = ["Flowers (154)", "Coffee (77)", "Tomorrowland (55)", "Maldives (44)"]
...
extension TrendsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: String(describing: TrendsTableViewCell.self), for: indexPath) as! TrendsTableViewCell
        cell.lblTitle.text = trendsList[indexPath.row]
